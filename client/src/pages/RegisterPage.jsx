...
const RegisterPage = () => {
    return (
        <div className='flex content-center items-center justify-center min-h-[100vh] '
            style={{
                backgroundImage:
        ...
        >
            <Tilt options={defaultOptions} className='w-[70%] h-[] bg-gradient-to-tr rounded-2xl flex content-center items-center justify-center '>
                {/* Signin card */}
                <div class="relative flex flex-col text-gray-700 bg-[#ffffff] shadow-md w-96 rounded-xl bg-clip-border">
                    ...
                    <div class="flex flex-col gap-4 p-6">
                        ...
                        <Input title='Camera Model' />
                        <Input title='Camera Location' />
                        <Input title='Camera Resolution' />
                        <Input title='Camera Range' />
                        <Input title='Camera IP Address' />
                    </div>
                    <div class="p-6 pt-0">
                        <button
